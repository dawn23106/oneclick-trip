...
_CITY_MEALS: dict[str, dict[str, tuple[str, ...]]] = {
    "成都": {
        "lunch": ("担担面与钟水饺", "钟水饺与甜水面", "钵钵鸡与蛋烘糕", "红油抄手与三大炮", "冒菜配米饭"),
        "dinner": ("牛油火锅涮毛肚鸭肠", "串串香配唯怡豆奶", "蹄花汤与麻辣兔头", "经典川菜（回锅肉、麻婆豆腐）", "建设路夜市边走边吃"),
    },
    "杭州": {
        "lunch": ("片儿川配葱包烩", "知味小吃（猫耳朵、小笼包）", "奎元馆虾爆鳝面", "龙井村茶点配藕粉"),
        "dinner": ("东坡肉与龙井虾仁", "西湖醋鱼配莼菜汤", "叫花童子鸡与宋嫂鱼羹", "河坊街夜市逛吃"),
    },
    "西安": {
        "lunch": ("肉夹馍配凉皮", "Biangbiang面三合一", "贾三灌汤包", "葫芦头泡馍", "水盆羊肉配月牙饼"),
        "dinner": ("羊肉泡馍自己掰", "回民街洒金桥小吃串烧", "麻酱凉皮与甑糕", "长安大排档一站式体验"),
    },
    "大理": {
        "lunch": ("喜洲破酥粑粑配凉鸡米线", "巍山扒肉饵丝", "漾濞卷粉与豌豆粉", "白族砂锅鱼"),
        "dinner": ("野生菌火锅（雨季必吃）", "白族石板烧与酸辣鱼", "腊排骨火锅", "古城南门夜市逛吃"),
    },
    "长沙": {
        "lunch": ("长沙米粉配剁椒", "臭豆腐与糖油粑粑", "辣椒炒肉盖码饭"),
        "dinner": ("口味虾与跳跳蛙", "费大厨辣椒炒肉", "夜市风味晚餐（冬瓜山烤肠、紫苏桃子）"),
    },
}
