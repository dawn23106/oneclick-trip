...
class Settings:
    ...
    agent_reach_fallback_enabled: bool = False
...
def load_settings(env_file: Path | None = None) -> Settings:
    ...
    return Settings(
        ...
        agent_job_ttl_minutes=max(
            1, int(os.getenv("AGENT_JOB_TTL_MINUTES", "1440"))
        ),
        ...
        in {"1", "true", "yes", "on"},
        agent_reach_fallback_enabled=os.getenv(
            "AGENT_REACH_FALLBACK_ENABLED", "false"
        ).lower()
        in {"1", "true", "yes", "on"},
