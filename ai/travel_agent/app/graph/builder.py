...
from app.agents.plan_preference_agent import PlanPreferenceAgent, RuleBasedPlanPreferenceAgent
...
def build_travel_graph(
    ...
    planning_subgraph = build_planning_subgraph(
        ...
        direct_planner_agent=direct_planner_agent or RuleBasedDirectPlannerAgent(),
        planner_agent=planner_agent or RuleBasedPlannerAgent(),
        plan_presenter=configured_plan_presenter,
        plan_preference_agent=plan_preference_agent or RuleBasedPlanPreferenceAgent(),
