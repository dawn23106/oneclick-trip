...
module.exports = {
  ...
  updateAiTripStatus: (id, tripStatus) => request(`/api/trip-plans/ai/${id}/status`, { method: 'PUT', data: { tripStatus } }),
  updateTripStatus: (id, tripStatus) => request(`/api/trip-plans/${id}/status`, { method: 'PUT', data: { tripStatus } }),
