...
import com.oneclicktrip.security.ApiRateLimitFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/oneclick-trip-assets/**").permitAll()
    ...
    public CorsConfigurationSource corsConfigurationSource(
            @Value("${app.cors.allowed-origin-patterns:http://localhost:5173,http://localhost:5174}")
