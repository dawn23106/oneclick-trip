    ...
    <div class="table-card">
      ...
      <div class="card-body">
        <el-table :data="list" stripe style="width:100%" v-loading="loading">
          ...
          <el-table-column prop="name" label="美食名称" min-width="140" />
          ...
          <el-table-column prop="recommendedArea" label="推荐区域" width="110" />
        ...
        <el-row :gutter="16">
          <el-col :span="12">
            <el-form-item label="美食名称" prop="name">
              <el-input v-model="form.name" placeholder="例如：火锅" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
        ...
        <el-row :gutter="16">
          <el-col :span="12">
            <el-form-item label="分类" prop="category">
              <el-input v-model="form.category" placeholder="例如：火锅、小吃、面食" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="推荐区域">
              <el-input v-model="form.recommendedArea" placeholder="例如：春熙路" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-form-item label="简介" prop="summary">
          <el-input v-model="form.summary" type="textarea" :rows="2" placeholder="美食简介" />
        </el-form-item>
        <el-row :gutter="16">
          <el-col :span="8">
...
import { fetchFoods, fetchFood, createFood, updateFood, deleteFood, fetchCities } from '../api/admin.js'
...
const form = reactive({
  name: '', cityId: null, category: '', summary: '',
  recommendedArea: '', avgPrice: 0, sortOrder: 0, status: 1
})
...
async function openDialog(row) {
  if (row) {
    ...
    try {
      const data = await fetchFood(row.id)
